 ...
 */
public class UcmdbCIUpdatePostFunction extends AbstractJiraFunctionProvider
{
    private static final Logger log = LoggerFactory.getLogger(UcmdbCIUpdatePostFunction.class);
